...
class ArgumentParser():
    ...
    def add_base_parameters(self):
        ...
        base_params.add_argument(
            '--model-aff', type=str, default='', help='Trained affine model filename'
        )
        base_params.add_argument(
            '--model-tps', type=str, default='', help='Trained TPS model filename'
        )
    ...
    def add_synth_dataset_parameters(self):
        ...
        dataset_params.add_argument(
            '--random-t', type=float, default=0.5, help='random transformation translation'
        )
        dataset_params.add_argument(
            '--random-s', type=float, default=0.5, help='random transformation translation'
        )
        dataset_params.add_argument(
            '--random-alpha', type=float, default=1 / 6, help='random transformation translation'
        )
        dataset_params.add_argument(
            '--random-t-tps', type=float, default=0.4, help='random transformation translation'
        )
    ...
    def add_weak_dataset_parameters(self):
        ...
        dataset_params.add_argument(
            '--dataset-csv-path',
            type=str,
            default='training_data/pf-pascal-flip/',
            help='path to training transformation csv folder'
        )
        dataset_params.add_argument(
            '--dataset-image-path',
            type=str,
            default='datasets/proposal-flow-pascal/',
            help='path to folder containing training images'
        )
        dataset_params.add_argument(
            '--categories',
            ...
            type=int,
            default=0,
            help='indices of categories for training/eval'
        )
        ...
        dataset_params.add_argument(
            '--pck-alpha', type=float, default=0.1, help='pck margin factor alpha'
        )
    ...
    def add_train_parameters(self):
        ...
        train_params.add_argument(
            '--weight-decay', type=float, default=0, help='weight decay constant'
        )
        ...
        train_params.add_argument(
            '--result-model-fn', type=str, default='checkpoint_adam', help='trained model filename'
        )
        train_params.add_argument(
            '--result-model-dir',
            type=str,
        ...
        train_params.add_argument(
            '--training-dataset', type=str, default='pascal', help='dataset to use for training'
        )
        # Limit train/test dataset sizes
        train_params.add_argument(
            '--train-dataset-size', type=int, default=0, help='train dataset size limit'
        )
        train_params.add_argument(
            '--test-dataset-size', type=int, default=0, help='test dataset size limit'
        )
        ...
        train_params.add_argument(
            ...
            const=True,
            default=False,
            help='Update batch norm running mean and std'
        )
    ...
    def add_weak_loss_parameters(self):
        ...
        loss_params.add_argument(
            '--tps-reg-factor', type=float, default=0.2, help='tps regularization factor'
        )
        loss_params.add_argument(
            '--normalize-inlier-count', type=str_to_bool, nargs='?', const=True, default=True
        )
        loss_params.add_argument(
            '--dilation-filter',
            type=int,
            default=0,
            help='type of dilation filter: 0:no filter;1:4-neighs;2:8-neighs'
        )
        loss_params.add_argument(
            '--use-conv-filter',
            type=str_to_bool,
            ...
            const=True,
            default=False,
            help='use conv filter instead of dilation'
        )
    ...
    def add_eval_parameters(self):
        ...
        eval_params.add_argument(
            '--eval-dataset-path', type=str, default='', help='Path to PF dataset'
        )
        eval_params.add_argument(
            '--flow-output-dir', type=str, default='results/', help='flow output dir'
        )
        eval_params.add_argument(
            '--pck-alpha', type=float, default=0.1, help='pck margin factor alpha'
        )
        ...
        eval_params.add_argument(
            '--tps-reg-factor', type=float, default=0.0, help='regularisation factor for tps tnf'
        )
    ...
    def add_cnn_model_parameters(self):
        ...
        model_params.add_argument(
            ...
            type=int,
            default=[7, 5],
            help='kernels sizes in feat.reg. conv layers'
        )
        model_params.add_argument(
            '--fr-channels',
            nargs='+',
            type=int,
            default=[128, 64],
            help='channels in feat. reg. conv layers'
        )
