...
#block(name=weak_delf, threads=2, memory=7500, hours=1000, gpus=1)
    python3 -m train_weak                                                                                                     \
        --model-aff trained_models/best_delf_dist101_gcp_smallerlr_strong_30_pascal_affine_101_1000_full_20_grid_loss.pth.tar \
        --model-tps trained_models/best_delf_dist101_gcp_smallerlr_strong_30_pascal_tps_101_1000_full_20_grid_loss.pth.tar    \
        ...
        --num-epochs                    30                                                                                    \
        --lr                            5e-8                                                                                  \
	    --result-model-fn               delf_dist101_gcp_weak
